...
export type ToolType = 'ai_solver' | 'ai_image_solver' | 'ai_text_solver' | 'ai_video_title' | 'ai_hashtag' | 'ai_chatbot' | 'ai_health' | 'ai_prompt_hub' | 'ai_image_prompt' | 'ai_video_prompt' | 'ai_image_generator' | 'custom' | 'text' | 'generator' | 'calculator' | 'image_compressor' | 'image_converter' | 'text_to_pdf' | 'html_viewer' | 'url_shortener' | 'text_to_file' | 'pwa_generator' | 'web_to_app' | 'image_hosting';
